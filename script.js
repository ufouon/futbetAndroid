...
const messages = [
    'امروز کلا هرچی زدم خراب شد 😂',
    'بچه ها راند جدید شروع شد؟',
    'من این یکی رو رد کردم، حس خوبی بهش نداشتم',
    'عه چرا اینجوری شد 😐',
    'کسی نتیجه دست قبلی رو دید؟',
    'من فعلا دارم با مبلغ کم تست میکنم',
    'این یکی خیلی نزدیک بود 😳',
    'امروز اصلا شانس ندارم',
    'یکی بگه الان چند شد؟',
    'من گفتم این دستو نزن ولی خودم زدم 😂',
    'کسی هنوز اینجاست؟',
    'این راند واقعا عجیب بود',
    'یه برد کوچیک گرفتم فعلا نگهش میدارم',
    'نه دیگه این یکی رو واقعا اشتباه کردم',
    'بچه ها کسی امروز خوب پیش رفته؟',
    'من فعلا فقط نگاه میکنم 👀',
    'این نتیجه رو اصلا انتظار نداشتم',
    'امشب دیگه بیخیال میشم',
    'یکی بگه دست بعدی کیه',
    'من دو بار نزدیک بود برگردم سر نقطه اول 😅',
    'این یکی خوب نشست',
    'داداش عجله نکن',
    'من مبلغمو زیاد نکردم که ریسک نکنم',
    'کسی میدونه چرا اینقدر دیر شد؟',
    'امروز واقعا بالا پایین زیاد داشت',
    'من فعلا همون سود کوچیکو نگه داشتم ❤️',
    'این یکی از اولش مشکوک بود',
    'بچه ها شما چی میزنید؟',
    'من دیگه برای امشب بستمش',
    'عه اینم پرید 😂',
    'یه دست دیگه نگاه میکنم بعد میرم',
    'این دفعه دیگه عجله نمیکنم',
    'کسی نتیجه نهایی رو دید؟',
    'امروز اصلا طبق برنامه پیش نرفت',
    'من یه کم عقب کشیدم بهتر شد',
    'بسه دیگه برای امروز',
    'اووو این یکی خوب دراومد 😳',
    'من دیگه ادامه نمیدم، موفق باشید ✌️',
    'شب همگی بخیر ❤️'
];
